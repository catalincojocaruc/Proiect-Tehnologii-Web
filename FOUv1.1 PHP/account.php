...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <link rel="stylesheet" href="cssFiles/accountStyle.css">
    ...
    <div class="page-wrapper">
        ...
        <div class="row">
            <div class="column">
                ...
                <button type="button" name="button"><h3>Account details</h3></button></a>
                <br>
                <br>
                <a href="changepassword.php">
                <button type="button" name="button"><h3>Change password</h3></button></a>
                <br>
                <br>
              <a href="logoutProcess.php">
              <button type="button" name="button"><h3>Log out</h3></button></a>
                <br>
                <br>
                <a href="contactus.html">
                <button type="button" name="button"><h3>Contact us</h3></button></a>
                </div>
            </div>
          </div>
