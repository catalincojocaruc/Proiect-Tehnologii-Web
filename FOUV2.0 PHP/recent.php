...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <link rel="stylesheet" href="cssFiles/recentStyle.css">
...
if(isset($_SESSION['User']))
{
  ...
  $user_check_query = "SELECT * FROM fisiere WHERE username='$usr' and data >= DATE(NOW()) - INTERVAL 7 DAY";
