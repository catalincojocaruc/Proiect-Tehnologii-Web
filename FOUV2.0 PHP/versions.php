  ...
  <body>
    <div class="page-wrapper">
        ...
        <div class="row">
            <div class="column">
                <div class="main">
                  <h1> There are your file versions for : <?php $parent=$_GET['parent_file']; echo $parent;  ?> ! </h1>
                  <br>
                  <br>
...
if(isset($_SESSION['User']))
{
    ...
    $user_check_query = "SELECT * FROM fisiere WHERE username='$usr' and parent_file='$parent'";
